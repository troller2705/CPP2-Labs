...
namespace Invector.FootstepSystem
{
    ...
    public class FootstepObject
    {
        ...
        public vFootstepMaterialHandler stepHandle;
        ...
        public FootstepObject(Transform sender, Collider ground)
        {
            ...
            this.stepHandle = ground.GetComponent<vFootstepMaterialHandler>();
            ...
            if (renderer != null && renderer.material != null)
            {
                ...
                if (stepHandle)
                {
                    ...
                    {
                        case vFootstepMaterialHandler.StepHandleType.materialName:
                            this.name = renderer.materials[index].name;
                            break;
                        case vFootstepMaterialHandler.StepHandleType.textureName:
